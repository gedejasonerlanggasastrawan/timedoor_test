  ...
  <div class="d-flex">
    <div class="card fontDmSans">
      <div class="image-container">
        ...
        <NuxtLink :to="`/update-story/${storyId}`" class="update-icon"></NuxtLink>
        <div class="bookmark-icon"></div>
        <div @click="handleTrash(id)" class="trash-icon"></div>
      </div>
      <div class="card-body">
...
const handleTrash = async (id) => {
  try {
    ...
    // console.log(ngrokUrl + '/api/stories/' + id);

    await axios.delete(`${ngrokUrl}/api/stories/${id}`, {
      headers: {
